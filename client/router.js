...
const routes = [
...

  {
    ...
    name: 'house',
    component: page('developers/developer/object/house/_id.vue')
  },
  ...
  { path: '/super_admin/edit_home_page', name: 'super_admin', component: page('super_admin/edit_home_page.vue') }
]
